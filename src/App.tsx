    ...
    <div className="min-h-screen bg-slate-50 text-slate-950">
      <header className="sticky top-0 z-50 border-b border-slate-200/70 bg-white/85 backdrop-blur-xl">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4 lg:px-8">
          <a href="#" className="flex items-center gap-3">
            <div className="flex h-10 w-10 items-center justify-center rounded-xl border border-blue-400/30 bg-gradient-to-br from-blue-500 to-blue-700 text-sm font-bold text-white shadow-md shadow-blue-600/10">
              AD
            </div>
      ...
      <main>
        ...
        <section className="relative overflow-hidden bg-white">
          ...
          <div className="mx-auto grid min-h-[700px] max-w-7xl items-center gap-12 px-6 py-20 lg:grid-cols-[0.95fr_1.05fr] lg:px-8">
            <div className="relative z-10">
              ...
              <h1 className="max-w-3xl title-hero font-bold">
            ...
            <div className="mt-14 grid gap-6 lg:grid-cols-3">
              <article className="group relative overflow-hidden rounded-[2rem] border border-blue-200 bg-white p-8 shadow-sm transition duration-300 hover:-translate-y-1 hover:shadow-xl">
                ...
                <div className="relative">
                  ...
                  <h3 className="title-card font-bold">
                    FundraisingPortal
                  </h3>
              ...
              <article className="group rounded-[2rem] border border-slate-200 bg-white p-8 transition duration-300 hover:-translate-y-1 hover:border-blue-200 hover:shadow-xl">
                ...
                <h3 className="title-card font-bold">DevisFlow</h3>
              ...
              <article className="group rounded-[2rem] border border-slate-200 bg-white p-8 transition duration-300 hover:-translate-y-1 hover:border-blue-200 hover:shadow-xl">
                ...
                <h3 className="title-card font-bold">DonorFlow</h3>
          ...
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="grid gap-12 lg:grid-cols-[0.9fr_1.1fr] lg:items-end">
              <div>
                ...
                <h2 className="title-section font-bold">
                  Des solutions digitales construites autour de besoins réels.
                </h2>
              </div>

              <p className="max-w-2xl text-lg leading-8 text-slate-600">
                Notre activité se concentre aujourd'hui sur l'intelligence
                artificielle et l'automatisation métier, tout en s'appuyant sur
                une expérience antérieure dans la conception et la mise en ligne
                de solutions web.
              </p>
            </div>
            ...
            <div className="mt-14">
              ...
              <article className="rounded-[2rem] border border-blue-200 bg-white p-8 shadow-sm">
                <div className="flex flex-col gap-8 lg:flex-row lg:items-center lg:justify-between">
                  <div className="max-w-3xl">
                    ...
                    <p className="mt-4 leading-7 text-slate-600">
                      Plateforme dédiée à l'analyse de dossiers, la qualification,
                      la recherche de financeurs et au suivi structuré des
                      opportunités de financement.
                    </p>

                    <p className="mt-5 text-sm font-semibold text-slate-500">
                      IA · Analyse documentaire · Matching · Pipeline · Automatisation
                    </p>
                  </div>

                  <Link
                    to="/products/fundraising"
                    className="inline-flex shrink-0 items-center gap-2 font-bold text-blue-600"
                  >
                    Voir le projet
                    <ArrowRight size={17} />
                  </Link>
            ...
            <div className="mt-16">
              <div className="mb-7">
                <p className="text-sm font-bold uppercase tracking-[0.2em] text-blue-600">
                  Web & présence digitale
                </p>

                <p className="mt-3 max-w-2xl text-slate-500">
                  Sélection de réalisations web antérieures.
                </p>
              </div>
              ...
              <div className="grid gap-6 md:grid-cols-2">
                <article className="group rounded-[2rem] border border-slate-200 bg-white p-8 transition duration-300 hover:-translate-y-1 hover:border-blue-200 hover:shadow-xl">
                  ...
                  <p className="mt-4 leading-7 text-slate-600">
                    Boutique en ligne et présence digitale.
                  </p>

                  <a
                    href="https://jewelboxx31.com/boutique"
                    target="_blank"
                    rel="noreferrer"
                    className="mt-7 inline-flex items-center gap-2 font-bold text-blue-600"
                  >
                    Voir le site
                    <ArrowRight
                      size={17}
                ...
                <article className="group rounded-[2rem] border border-slate-200 bg-white p-8 transition duration-300 hover:-translate-y-1 hover:border-blue-200 hover:shadow-xl">
                  ...
                  <p className="mt-4 leading-7 text-slate-600">
                    Site vitrine et présence digitale.
                  </p>

                  <a
                    href="https://eauvalis.com/il#/accueil"
                    target="_blank"
                    rel="noreferrer"
                    className="mt-7 inline-flex items-center gap-2 font-bold text-blue-600"
                  >
                ...
                <article className="rounded-[2rem] border border-dashed border-slate-300 bg-white/60 p-8">
                  ...
                  <p className="mt-4 leading-7 text-slate-400">
                    Une nouvelle réalisation sera ajoutée prochainement.
                  </p>
                </article>
            ...
            <div className="mt-14 grid gap-6 md:grid-cols-3">
              {[
                ...
                >
                  ...
                  <h3 className="title-card font-bold">{item.title}</h3>
        ...
        {/* WHY AD CONSULTING IA */}
        <section className="bg-slate-50 py-24">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="max-w-3xl">
              <p className="text-sm font-bold uppercase tracking-[0.22em] text-blue-600">
                Pourquoi AD Consulting IA
              </p>

              <h2 className="title-section font-bold">
                Des systèmes pensés pour évoluer avec vos besoins.
              </h2>
            </div>
              ...
              {[
                {
                  ...
                  text: 'Nos solutions sont conçues pour communiquer entre elles et partager progressivement données, automatisations et intelligence métier.',
                },
                {
                  title: 'Architecture évolutive',
                  text: 'Chaque produit peut évoluer indépendamment tout en restant compatible avec un socle commun et une vision d’écosystème.',
                },
                {
                  title: 'Pilotage intelligent',
                  text: 'L’objectif n’est pas seulement d’automatiser, mais d’améliorer la qualité des décisions grâce à des données exploitables.',
                },
              ].map((item) => (
                <article
                  key={item.title}
                ...
                >
                  <div className="mb-6 h-2 w-10 rounded-full bg-blue-600" />
              ...
              <div className="relative grid gap-8 md:grid-cols-4">
                {ecosystemProducts.map((product, index) => (
                  <article
                    ...
                    className="relative"
                  >
                    <div className="relative z-10 flex h-12 w-12 items-center justify-center rounded-full border-4 border-white bg-blue-600 text-sm font-bold text-white shadow-md">
                      {index + 1}
                    </div>
      ...
      <footer className="border-t border-slate-800 bg-slate-950 text-white">
        <div className="mx-auto grid max-w-7xl gap-12 px-6 py-14 md:grid-cols-2 lg:grid-cols-4 lg:px-8">
          <div>
            ...
            <p className="mt-4 max-w-xs leading-7 text-slate-400">
              Des systèmes intelligents conçus pour automatiser, structurer et
          ...
          <div>
            ...
            <div className="mt-4 space-y-3 text-sm text-slate-400">
              ...
              <a href="#portfolio" className="block hover:text-white">Réalisations</a>
              <a href="#vision" className="block hover:text-white">Vision</a>
            </div>
          </div>

          <div>
            <p className="font-bold">Écosystème</p>

            <div className="mt-4 space-y-3 text-sm text-slate-400">
              <Link to="/products/fundraising" className="block hover:text-white">
                FundraisingPortal
              </Link>

              <Link to="/products/devisflow" className="block hover:text-white">
                DevisFlow
              </Link>

              <Link to="/products/donorflow" className="block hover:text-white">
                DonorFlow
              </Link>
            </div>
          </div>
        ...
        <div className="border-t border-white/10">
          <div className="mx-auto flex max-w-7xl flex-col gap-3 px-6 py-6 text-sm text-slate-500 sm:flex-row sm:items-center sm:justify-between lg:px-8">
            <p>
              © 2026 AD Consulting IA. Tous droits réservés.
            </p>
